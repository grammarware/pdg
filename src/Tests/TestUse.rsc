...
test bool testUse1(){
	CF cf = buildControlFlow(getMethodAST(|project://JavaTest/src/PDG/dataFlow/Use.java|)[0]);
...
test bool testUse2(){
	CF cf = buildControlFlow(getMethodAST(|project://JavaTest/src/PDG/dataFlow/Use.java|)[1]);
	map[int, set[str]] uses = getUses();
